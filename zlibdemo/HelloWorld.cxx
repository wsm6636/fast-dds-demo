...
{
    // m_index com.eprosima.idl.parser.typecode.PrimitiveTypeCode@17211155
    m_index = 0;
    // m_message com.eprosima.idl.parser.typecode.StringTypeCode@b3d7190
    m_message ="";
    // m_data com.eprosima.idl.parser.typecode.ArrayTypeCode@5fdba6f9
    memset(&m_data, 0, (20480) * 1);
        ...
        size_t current_alignment)
{
    ...
    current_alignment += ((20480) * 1) + eprosima::fastcdr::Cdr::alignment(current_alignment, 1);
...
void HelloWorld::data(
        const std::array<char, 20480>& _data)
{
    m_data = _data;
}
 ...
 */
const std::array<char, 20480>& HelloWorld::data() const
{
    return m_data;
}
 ...
 */
std::array<char, 20480>& HelloWorld::data()
{
    return m_data;
}
